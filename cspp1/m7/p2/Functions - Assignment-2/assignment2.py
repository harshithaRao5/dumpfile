...
# The program should print out one line: the lowest monthly payment that will pay off
# all debt in under 1 year, for example:
# Lowest Payment: 180
...
def paying_debt_off_in_a_year(updated_balance, annual_interest_rate):
    """# Assume that the interest is compounded monthly according to the balance
    # at the end of the month (after the payment for that month is made).
    # The monthly payment must be a multiple of $10
    # and is the same for all months. Notice that it is
