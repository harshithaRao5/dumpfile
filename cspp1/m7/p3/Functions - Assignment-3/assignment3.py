...
# that we can pay off the debt within a year. Try it out with
...
# value as you did in Assignment 2."""
    ...
    while True:
        ...
        while j <= 12:
            ...
            j += 1
        if new_balance > 0 and new_balance > i:
            monthly_payment_lower_bound = guess
            new_balance = balance
        elif new_balance < 0 and new_balance < -i:
